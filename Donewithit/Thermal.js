      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section1')}>
        ...
        {isSectionActive('section1') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Plant Load Factor: {plantLoadFactor}</Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section4')}>
        ...
        {isSectionActive('section4') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Overall Efficiency: {overallEfficiency}</Text>
          </View>
        )}
      </TouchableOpacity>

      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section5')}>
