...
const CoolingTower = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Ambient-Wet Bulb Near Cooling Tower (℃):</Text>
        <TextInput
          value={C}
          onChangeText={setC}
          keyboardType="numeric"
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Ambient-Dry Bulb Near Cooling Tower (℃):</Text>
        <TextInput
          value={D}
          onChangeText={setD}
          keyboardType="numeric"
      ...
      <View style={styles.table}>
        <View style={styles.tableCell}>
          <Text style={styles.tableHeader}>Effectiveness, (F / (F + G)) * 100 (%)</Text>
