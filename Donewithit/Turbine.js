        ...
        {isSectionActive('section1') && (
          <View style={styles.sectionContent}>
            ...
            <TextInput
              ...
              onChangeText={(value) => setGrossGeneratorOutput(parseFloat(value))}
              keyboardType="numeric"
            />
            <Button title="Calculate" onPress={calculateTurbineHeatRate} />
            <Text style={styles.result}>Turbine Heat Rate: {turbineHeatRate} KCal/kWh</Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section2')}>
        ...
        {isSectionActive('section2') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Unit Heat Rate: {unitHeatRate} KCal/kWh</Text>
          </View>
        )}
      </TouchableOpacity>

      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section3')}>
        <Text style={styles.sectionTitle}>Section 3: Turbine Cycle Efficiency</Text>
        {isSectionActive('section3') && (
          <View style={styles.sectionContent}>
            <Text style={styles.info}>Turbine Heat Rate: {turbineHeatRate} KCal/kWh</Text>
            <Button title="Calculate" onPress={calculateTurbineCycleEfficiency} />
            <Text style={styles.result}>Turbine Cycle Efficiency: {turbineCycleEfficiency} %</Text>
          </View>
        )}
      </TouchableOpacity>

      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section4')}>
        <Text style={styles.sectionTitle}>Section 4: Turbine Stage Efficiency</Text>
        {isSectionActive('section4') && (
          <View style={styles.sectionContent}>
            ...
            <TextInput
              ...
              keyboardType="numeric"
            />
            <Button title="Calculate" onPress={calculateTurbineStageEfficiency} />
            <Text style={styles.result}>Turbine Stage Efficiency: {turbineStageEfficiency} %</Text>
          </View>
        )}
      </TouchableOpacity>
    </ScrollView>
