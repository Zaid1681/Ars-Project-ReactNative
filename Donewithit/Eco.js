      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section1')}>
        ...
        {isSectionActive('section1') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Economiser Effectiveness: {EcoPercentage}%</Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section2')}>
        ...
        {isSectionActive('section2') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Heat Pick-up in Economiser: {heatE}</Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section2')}>
        ...
        {isSectionActive('section2') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>APH Effectiveness: {APHPercentage}%</Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section2')}>
        ...
        {isSectionActive('section2') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Air leakage estimation: {airleakage}</Text>
          </View>
        )}
      </TouchableOpacity>


      <TouchableOpacity style={styles.section} onPress={() => toggleSection('section6')}>
        ...
        {isSectionActive('section6') && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>Terminal Temperature Difference {TTD}</Text>
          </View>
        )}
      </TouchableOpacity>
