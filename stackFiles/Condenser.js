    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      >
        <Text style={styles.sectionTitle}>
          Section 1: Condenser Effectiveness
        </Text>
        {isSectionActive("section1") && (
          <View style={styles.sectionContent}>
            ...
            <Button
              title="Calculate"
              onPress={calculateCondenserEffectiveness}
            />
            <Text style={styles.result}>
              Condenser Effectiveness: {condenserEffectiveness} %
            </Text>
          </View>
        )}
      </TouchableOpacity>
      ...
      >
        ...
        {isSectionActive("section2") && (
          <View style={styles.sectionContent}>
            ...
            <Text style={styles.result}>
              Condenser Heat Load: {condenserHeatLoad} kcal/hr
            </Text>
          </View>
        )}
      </TouchableOpacity>
        ...
        {isSectionActive("section3") && (
          <View style={styles.sectionContent}>
            <TextInput
              ...
              onChangeText={(value) =>
                setAtmosphericPressure(parseFloat(value))
              }
              keyboardType="numeric"
            />
            <TextInput
              ...
              onChangeText={(value) =>
                setCondenserBackPressure(parseFloat(value))
              }
              keyboardType="numeric"
            />
            <Button title="Calculate" onPress={calculateCondenserVacuum} />
            <Text style={styles.result}>
              Condenser Vacuum: {condenserVacuum} mmHg
            </Text>
          </View>
        )}
      </TouchableOpacity>
